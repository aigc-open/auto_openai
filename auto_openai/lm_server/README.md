...
python3 -m auto_openai.lm_server.start get_vllm Qwen2.5-VL-7B-Instruct 5 1 7861 /template/template_qwen.jinja 1024 gcu "" vllm-qwen25-vl
python3 -m auto_openai.lm_server.start get_vllm test-model 5 1 7861 /template/template_qwen.jinja 1024 auto 
