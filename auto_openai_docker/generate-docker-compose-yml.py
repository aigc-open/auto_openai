...
class Gen:
    ...
    default_container = {
        ...
        "command": [
            "/bin/sh",
            "-c",
            "if [ -d /root/share_models/auto_openai/ ]; then cp -rf /root/share_models/auto_openai/auto_openai /app/ && python3 -m auto_openai.scheduler; else python3 -m auto_openai.scheduler; fi"
        ],
        "restart": "always",
