...
docker-compose -f scheduler-3-3-3-3-of-1-bge-base-zh-v1.5-docker-compose.yml down
docker-compose -f scheduler-3-3-3-3-of-1-bge-reranker-v2-m3-docker-compose.yml down
